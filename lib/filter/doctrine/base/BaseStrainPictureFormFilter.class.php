...
/**
 * StrainPicture filter form base class.
 *
 ...
 */
abstract class BaseStrainPictureFormFilter extends BaseFormFilterDoctrine {
  public function setup() {
    ...
    $this->widgetSchema->setNameFormat('strain_picture_filters[%s]');
