...
/**
 * FieldPicture filter form base class.
 *
 * @package    ACM
 * @subpackage filter
 * @author     
 ...
 */
abstract class BaseFieldPictureFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('field_picture_filters[%s]');
