...
/**
 * DetailedPicture filter form base class.
 *
 ...
 */
abstract class BaseDetailedPictureFormFilter extends BaseFormFilterDoctrine {
  public function setup() {
    ...
    $this->widgetSchema->setNameFormat('detailed_picture_filters[%s]');
