...
/**
 * DnaSequenceReaction filter form base class.
 *
 ...
 */
abstract class BaseDnaSequenceReactionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'primer'          => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->setValidators(array(
      'primer'          => new sfValidatorPass(array('required' => false)),
    ...
    $this->widgetSchema->setNameFormat('dna_sequence_reaction_filters[%s]');
