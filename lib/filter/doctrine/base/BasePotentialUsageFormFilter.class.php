...
/**
 * PotentialUsage filter form base class.
 *
 * @package    ACM
 * @subpackage filter
 * @author     
 ...
 */
abstract class BasePotentialUsageFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('potential_usage_filters[%s]');
  ...
  public function addUsageAreasListColumnQuery(Doctrine_Query $query, $field, $values)
  {
    ...
    $query
      ->leftJoin($query->getRootAlias().'.UsageAreaUsages UsageAreaUsages')
      ->andWhereIn('UsageAreaUsages.usage_area_id', $values)
    ;
  }
