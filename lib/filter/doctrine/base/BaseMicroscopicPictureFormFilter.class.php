...
/**
 * MicroscopicPicture filter form base class.
 *
 ...
 */
abstract class BaseMicroscopicPictureFormFilter extends BaseFormFilterDoctrine {
  public function setup() {
    ...
    $this->widgetSchema->setNameFormat('microscopic_picture_filters[%s]');
