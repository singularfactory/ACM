...
/**
 * MaintenanceDepositRelative filter form base class.
 *
 * @package ACM.Lib.Filter
 * @since 1.0
 */
abstract class BaseMaintenanceDepositRelativeFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('maintenance_deposit_relative_filters[%s]');
