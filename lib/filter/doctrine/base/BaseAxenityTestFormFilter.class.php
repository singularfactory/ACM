...
/**
 * AxenityTest filter form base class.
 *
 ...
 */
abstract class BaseAxenityTestFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('axenity_test_filters[%s]');
