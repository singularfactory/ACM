...
abstract class BaseEcosystemFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'picture_1'         => new sfWidgetFormFilterInput(),
      'picture_2'         => new sfWidgetFormFilterInput(),
      'picture_3'         => new sfWidgetFormFilterInput(),
      'picture_4'         => new sfWidgetFormFilterInput(),
      'picture_5'         => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'picture_1'         => new sfValidatorPass(array('required' => false)),
      'picture_2'         => new sfValidatorPass(array('required' => false)),
      'picture_3'         => new sfValidatorPass(array('required' => false)),
      'picture_4'         => new sfValidatorPass(array('required' => false)),
      'picture_5'         => new sfValidatorPass(array('required' => false)),
