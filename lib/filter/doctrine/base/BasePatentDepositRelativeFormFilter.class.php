...
/**
 * PatentDepositRelative filter form base class.
 *
 * @package ACM.Lib.Filter
 * @since 1.0
 */
abstract class BasePatentDepositRelativeFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('patent_deposit_relative_filters[%s]');
