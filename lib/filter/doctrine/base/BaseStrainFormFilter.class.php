...
abstract class BaseStrainFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'phylogenetic_description' => new sfWidgetFormFilterInput(),
      'phylogenetic_tree'        => new sfWidgetFormFilterInput(),
      'habitat_description'      => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'culture_medium_id'        => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('CultureMedium'), 'column' => 'id')),
      ...
      'phylogenetic_description' => new sfValidatorPass(array('required' => false)),
      'phylogenetic_tree'        => new sfValidatorPass(array('required' => false)),
      'habitat_description'      => new sfValidatorPass(array('required' => false)),
  ...
  public function getFields()
  {
    return array(
      ...
      'phylogenetic_description' => 'Text',
      'phylogenetic_tree'        => 'Text',
