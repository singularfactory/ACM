...
abstract class BaseStrainForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'dna_id'                     => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('Dna'), 'add_empty' => false)),
      ...
      'depositor_date'             => new sfWidgetFormDate(),
      'identifier_id'              => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('Identifier'), 'add_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'dna_id'                     => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('Dna'))),
      ...
      'depositor_date'             => new sfValidatorDate(),
      'identifier_id'              => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('Identifier'))),
