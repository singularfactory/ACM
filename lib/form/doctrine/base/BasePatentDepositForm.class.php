...
abstract class BasePatentDepositForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'bp1_link'                   => new sfWidgetFormTextarea(),
      'bp4_link'                   => new sfWidgetFormTextarea(),
    ...
    $this->setValidators(array(
      ...
      'depositor_code'             => new sfValidatorString(array('max_length' => 40, 'required' => false)),
      ...
      'bp1_link'                   => new sfValidatorString(array('max_length' => 1024)),
      'bp4_link'                   => new sfValidatorString(array('max_length' => 1024)),
