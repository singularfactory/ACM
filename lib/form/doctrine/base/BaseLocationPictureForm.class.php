...
/**
 * LocationPicture form base class.
 *
 * @method LocationPicture getObject() Returns the current form's model object
 *
 * @package ACM.Lib.Form
 * @since 1.0
 */
abstract class BaseLocationPictureForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('location_picture[%s]');
