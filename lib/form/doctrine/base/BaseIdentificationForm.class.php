...
abstract class BaseIdentificationForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'microscopy_identification' => new sfWidgetFormInputText(),
      'molecular_identification'  => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'microscopy_identification' => new sfValidatorString(array('max_length' => 255, 'required' => false)),
      'molecular_identification'  => new sfValidatorString(array('max_length' => 255, 'required' => false)),
