...
/**
 * MaintenanceDepositMaintenanceStatus form base class.
 *
 * @method MaintenanceDepositMaintenanceStatus getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseMaintenanceDepositMaintenanceStatusForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('maintenance_deposit_maintenance_status[%s]');
  ...
  {
    return 'MaintenanceDepositMaintenanceStatus';
  }
