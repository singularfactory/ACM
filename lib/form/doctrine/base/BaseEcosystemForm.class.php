...
abstract class BaseEcosystemForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'picture_1'         => new sfWidgetFormInputText(),
      'picture_2'         => new sfWidgetFormInputText(),
      'picture_3'         => new sfWidgetFormInputText(),
      'picture_4'         => new sfWidgetFormInputText(),
      'picture_5'         => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'picture_1'         => new sfValidatorString(array('max_length' => 255, 'required' => false)),
      'picture_2'         => new sfValidatorString(array('max_length' => 255, 'required' => false)),
      'picture_3'         => new sfValidatorString(array('max_length' => 255, 'required' => false)),
      'picture_4'         => new sfValidatorString(array('max_length' => 255, 'required' => false)),
      'picture_5'         => new sfValidatorString(array('max_length' => 255, 'required' => false)),
