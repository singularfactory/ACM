...
/**
 * PotentialUsage form base class.
 *
 * @method PotentialUsage getObject() Returns the current form's model object
 *
 * @package    ACM
 * @subpackage form
 * @author     
 ...
 */
abstract class BasePotentialUsageForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('potential_usage[%s]');
