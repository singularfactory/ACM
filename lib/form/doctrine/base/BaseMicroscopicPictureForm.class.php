...
/**
 * MicroscopicPicture form base class.
 *
 * @method MicroscopicPicture getObject() Returns the current form's model object
 *
...
abstract class BaseMicroscopicPictureForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('microscopic_picture[%s]');
