...
/**
 * DetailedPicture form base class.
 *
 * @method DetailedPicture getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseDetailedPictureForm extends BaseFormDoctrine {
  public function setup() {
    ...
    $this->widgetSchema->setNameFormat('detailed_picture[%s]');
