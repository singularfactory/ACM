 ...
 * @method DetailedPicture setId()        Sets the current record's "id" value
 * @method DetailedPicture setFilename()  Sets the current record's "filename" value
 * @method DetailedPicture setSampleId()  Sets the current record's "sample_id" value
 * @method DetailedPicture setSample()    Sets the current record's "Sample" value
 * 
 * @package    ACM
 * @subpackage model
 * @author     
