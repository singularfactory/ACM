 ...
 */
abstract class BasePetitioners extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('petitioners');
        ...
        $this->index('petitioner_name', array(
             'fields' => 
             array(
              'name' => 
              array(
        ...
        $this->index('petitioner_surname', array(
             'fields' => 
             array(
              'surname' => 
              array(
