 ...
 * @property boolean $is_blend
 * @property string $blend_description
 ...
 * @method MaintenanceDeposit  setYearlyCount()                         Sets the current record's "yearly_count" value
...
abstract class BaseMaintenanceDeposit extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('is_blend', 'boolean', null, array(
             'type' => 'boolean',
             'notnull' => true,
             'default' => false,
             ));
        $this->hasColumn('blend_description', 'string', null, array(
             'type' => 'string',
             ));
