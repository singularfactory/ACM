...
class Version211 extends Doctrine_Migration_Base {
	public function up() {
		...
		$this->createTable('potential_usages', array(
			'id' => array( 'type' => 'integer', 'primary' => '1', 'autoincrement' => '1', 'length' => '8',),
			'strain_taxonomy_id' => array( 'type' => 'integer', 'notnull' => '1', 'length' => '8',),
			...
			'type' => 'INNODB',
			'indexes' => array( 'unique_potential_usage' => array( 'fields' => array( 0 => 'strain_taxonomy_id', 1 => 'usage_id',), 'type' => 'unique',),),
			'primary' => array( 0 => 'id',),
			'collate' => 'utf8_general_ci',
			'charset' => 'utf8',
		));
		$this->createTable('strain_taxonomy', array(
			'id' => array( 'type' => 'integer', 'primary' => '1', 'autoincrement' => '1', 'length' => '8',),
			...
			'type' => 'INNODB',
			'indexes' => array( 'unique_strain_taxonomy' => array( 'fields' => array( 0 => 'taxonomic_class_id', 1 => 'genus_id', 2 => 'species_id',), 'type' => 'unique',),),
			'primary' => array( 0 => 'id',),
			'collate' => 'utf8_general_ci',
			'charset' => 'utf8',
		));
		$this->createTable('usage_area_usage_targets', array(
			'id' => array( 'type' => 'integer', 'primary' => '1', 'autoincrement' => '1', 'length' => '8',),
			'usage_area_id' => array( 'type' => 'integer', 'notnull' => '1', 'length' => '8',),
			'usage_target_id' => array( 'type' => 'integer', 'notnull' => '1', 'length' => '8',),
			'created_at' => array( 'notnull' => '1', 'type' => 'timestamp', 'length' => '25',),
			'updated_at' => array( 'notnull' => '1', 'type' => 'timestamp', 'length' => '25',),
		), array(
			'type' => 'INNODB',
			'indexes' => array( 'unique_usage' => array( 'fields' => array( 0 => 'usage_area_id', 1 => 'usage_target_id',), 'type' => 'unique',),),
			'primary' => array( 0 => 'id',),
			'collate' => 'utf8_general_ci',
			'charset' => 'utf8',
		));
		$this->createTable('usage_target', array(
			'id' => array( 'type' => 'integer', 'primary' => '1', 'autoincrement' => '1', 'length' => '8',),
			...
			'type' => 'INNODB',
			'indexes' => array( 'usage_target_name' => array( 'fields' => array( 'name' => array( 'length' => '5',),),),),
			'primary' => array( 0 => 'id',),
			'collate' => 'utf8_general_ci',
			'charset' => 'utf8',
		));
	...
	public function down() {
		...
		$this->dropTable('potential_usages');
		$this->dropTable('usage_area_usage_targets');
		$this->dropTable('strain_taxonomy');
		$this->dropTable('usage_target');
	}
}
