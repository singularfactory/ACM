...
?>
<?php
if (in_array($model, array('location', 'sample', 'strain', 'dna_extraction', 'patent_deposit', 'maintenance_deposit', 'culture_medium', 'cryopreservation', 'external_strain', 'project', 'identification', 'potential_usage', 'isolation'))) {
