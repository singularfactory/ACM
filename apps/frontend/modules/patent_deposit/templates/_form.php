...
<form action="<?php echo url_for('patent_deposit/'.($form->getObject()->isNew() ? 'create' : 'update').(!$form->getObject()->isNew() ? '?id='.$form->getObject()->getId() : '')) ?>" method="post" <?php $form->isMultipart() and print 'enctype="multipart/form-data" ' ?>>
...
<?php endif; ?>
  <table>
    <tfoot>
      <tr>
        <td colspan="2">
          ...
          &nbsp;<a href="<?php echo url_for('patent_deposit/index') ?>">Back to list</a>
          <?php if (!$form->getObject()->isNew()): ?>
            &nbsp;<?php echo link_to('Delete', 'patent_deposit/delete?id='.$form->getObject()->getId(), array('method' => 'delete', 'confirm' => 'Are you sure?')) ?>
          <?php endif; ?>
    ...
    <tbody>
      ...
      <tr>
        <th><?php echo $form['bp1_link']->renderLabel() ?></th>
        <td>
      ...
      <tr>
        <th><?php echo $form['bp4_link']->renderLabel() ?></th>
        <td>
