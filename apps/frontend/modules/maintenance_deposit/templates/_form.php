	...
	<div id="right_side_form">
		...
		<div class="model_text_input_list">
			...
			<ul>
				...
				<li>
					<input type="hidden" name="maintenance_deposit[Relatives][<?php echo $i ?>][name]" value="<?php echo $relative['name'] ?>" id="maintenance_deposit_Relatives_<?php echo $i ?>_name" />
					<input type="hidden" name="maintenance_deposit[Relatives][<?php echo $i ?>][id]" value="<?php echo $relative['id'] ?>" id="maintenance_deposit_Relatives_<?php echo $i ?>_id" />
					<div class="model_text_input_value">
						<span><?php echo $relative['name'] ?></span>
						<div class="model_text_input_value_checkbox">
							<input type="checkbox" name="maintenance_deposit[Relatives][<?php echo $i ?>][delete_object]" id="maintenance_deposit_Relatives_<?php echo $i ?>_delete_object" />
							delete
						</div>
					</div>
				</li>
