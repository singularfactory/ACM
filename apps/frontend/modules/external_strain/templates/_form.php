...
<form action="<?php echo url_for('external_strain/'.($form->getObject()->isNew() ? 'create' : 'update').(!$form->getObject()->isNew() ? '?id='.$form->getObject()->getId() : '')) ?>" method="post" <?php $form->isMultipart() and print 'enctype="multipart/form-data" ' ?>>
...
<?php endif; ?>
  <table>
    <tfoot>
      <tr>
        <td colspan="2">
          ...
          &nbsp;<a href="<?php echo url_for('external_strain/index') ?>">Back to list</a>
          <?php if (!$form->getObject()->isNew()): ?>
            &nbsp;<?php echo link_to('Delete', 'external_strain/delete?id='.$form->getObject()->getId(), array('method' => 'delete', 'confirm' => 'Are you sure?')) ?>
          <?php endif; ?>
    ...
    <tbody>
      ...
      <tr>
        <th><?php echo $form['supervisor_id']->renderLabel() ?></th>
        <td>
      ...
      <tr>
        <th><?php echo $form['container_id']->renderLabel() ?></th>
        <td>
          <?php echo $form['container_id']->renderError() ?>
          <?php echo $form['container_id'] ?>
        </td>
      </tr>
      <tr>
        <th><?php echo $form['containers_list']->renderLabel() ?></th>
        <td>
      ...
      <tr>
        <th><?php echo $form['maintenance_status_list']->renderLabel() ?></th>
        <td>
