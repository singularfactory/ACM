...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	...
	<body>
		...
		<div id="header">
			...
			<div id="header_menu">
				<ul id="header_menu_tabs">
					...
					<li>
						<?php echo link_to('DNA Lab', '@extraction_kit', (preg_match('/^(extraction_kit|dna_polymerase)_?/', $route))?array('class' => 'header_menu_current_tab'):'') ?>
					</li>
					<li>
		...
		<div id="main">
			...
			<?php if ( preg_match('/^(extraction_kit|dna_polymerase)_?/', $route) ): ?>
			<div id="subsections_header">
